...
public class ConsumerDemoCooperativeRebalance {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoCooperativeRebalance.class);

    public static void main(String[] args) {
        log.info("Inside kafka consumer with shutdown hook and cooperative rebalance!");
